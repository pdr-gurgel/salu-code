/*
 * Salu Robot v0.2 - Sistema de Fala (Estilo Tamagotchi/BMO)
 * Robozinho animado com display ST7735 na HORIZONTAL
 * Nova funcionalidade: Sistema de fala com animacao de boca
 * 
 * Hardware:
 * - Arduino Uno
...
// Array de frases para o robo falar
String frases[] = {
  "Ola!",
  "Como vai?",
  "Eu sou o Salu!",
...
void setup() {
  ...
  Serial.begin(9600);
  Serial.println("Salu Robot v0.2 - Sistema de Fala iniciado!");
  
  // Fala inicial de apresentacao
  delay(1000);
  falar("Ola! Eu sou o Salu!");
  delay(2000);
  falar("Vou falar algumas coisas!");
}
...
void loop() {
  ...
  // Falar uma frase aleatoria a cada 6 segundos
  if (tempoAtual - tempoUltimaAnimacao > 6000 && !estaFalando) {
    int indice = random(0, totalFrases);
    falar(frases[indice]);
...
void falar(String texto) {
  ...
  // Preparar rosto para falar
  desenharRosto(FALANDO);
